...
public record UserRecord(
                ...
                @NotBlank(message = "El nombre es obligatorio") String names,
                ...
                @NotNull(message = "El salario base es obligatorio") @Digits(integer = 15, fraction = 0, message = "Formato de salario inválido") @Max(value = 15000000, message = "El salario base no puede ser mayor a 15000000") @Min(value = 0, message = "El salario base no puede ser menor a 0") BigDecimal salaryBase) {
